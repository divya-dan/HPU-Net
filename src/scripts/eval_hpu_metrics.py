...
def main():
    ...
    iou_rec_vals, hung_vals, ged_vals = [], [], []
    ...
    while kept < args.num_images and idx < len(ds):
        ...
        # 1) Posterior recon IoU (per grader, average)
        per_g = []
        for g in range(4):
        ...
        iou_rec_vals.append(sum(per_g) / len(per_g))

        # 2) Prior samples for distributional metrics
        preds = []
        ...
        # Hungarian IoU & GED^2 (clipped ≥ 0 in our implementation)
